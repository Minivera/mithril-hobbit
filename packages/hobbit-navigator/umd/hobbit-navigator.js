(function (global, factory) {
    ...
    var History = function () {
        ...
        function History() {
            ...
            if (location) {
                ...
                //but do not redirect.
                this.location = (typeof location === 'undefined' ? 'undefined' : babelHelpers.typeof(location)) === 'object' ? location : {
                    path: location,
    ...
    function r() {
        ...
        if (arguments[0].constructor === Array) {
            routes = arguments[0];
            if (arguments.length > 1 && babelHelpers.typeof(arguments[1]) === 'object') {
            ...
            if (arguments.length > 2 && babelHelpers.typeof(arguments[2]) === 'object') {
        ...
        for (var index in routes) {
            ...
            if (manager.compare(route, options)) {
                ...
                return m(routeComponent, [m(component, babelHelpers.extends({
                    location: manager.getLocation(),
                    params: Object.assign({}, manager.getState(), manager.extractParams(route, options))
                }, params))]);
            }
