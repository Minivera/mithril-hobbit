(function (global, factory) {
    ...
    function expand(expander) {
        //Normal function as rollup cannot handle this with arrow functions
        return function (component) {
            var _this = this;

            Object.keys(expander).forEach(function (func) {
                var _Object$assign;
                ...
                component = Object.assign({}, component, (_Object$assign = {}, _Object$assign[func] = function () {
    ...
    var withAttrsValidation = function withAttrsValidation(validators) {
        return function (component) {
            return enhance(function (attributes) {
                Object.keys(attributes).forEach(function (attr) {
                    if (validators.hasOwnProperty(attr) && !validators[attr](attributes[attr], attr, attributes)) {
     ...
     * as its argument so it can be easily composed.
     */
    var withState = function withState(valueName) {
        var setterName = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'set' + (valueName.charAt(0).toUpperCase() + valueName.slice(1));
    ...
    var withTransform = function withTransform(transformators) {
        return function (component) {
            return enhance(function (attributes) {
                ...
                var newAttrs = {};
                Object.keys(attributes).forEach(function (attr) {
                    if (transformators.hasOwnProperty(attr) && typeof transformators[attr] === 'function') {
